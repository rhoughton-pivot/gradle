...
class DistributionIntegritySpec extends DistributionIntegrationSpec {
    ...
    /*
     * Integration test to verify the integrity of the dependencies. The goal is to be able to verify the dependencies
    ...
    def "Verify jar dependencies"() {
        ...
        !errors.findAll { path, diff ->
            System.err.println "Sha-1 mismatch for ${diff[0]}: expected=${diff[1]}, actual=${diff[2]}"
            true
        }
    }
